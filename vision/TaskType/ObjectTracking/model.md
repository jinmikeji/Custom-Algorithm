...
- Model folder: [custom_person_demo](./person_counting_demo/model/custom_person_demo)
- Inference code: [custom_detect.py](./person_counting_demo/model/custom_detect.py)
- Model configuration file: [model.yaml](./person_counting_demo/model/model.yaml) 

## 1. custom_person_demo Folder
...
- The folder name `custom_person_demo` here refers to the <span style="color:red;"> model name </span> mentioned below. For custom algorithm packages, the folder can be renamed to any other name. 
- Users need to replace the default "model" file in the `custom_person_demo` folder with their own model file. The model file must be uniformly named <span style="color:red;"> model </span> and cannot be modified。
...
## 2. Inference Code [custom_detect.py](./person_counting_demo/model/custom_detect.py)  
...
- If using other object detection algorithms, you need to implement the inference logic yourself with reference to [custom_detect.py](./person_counting_demo/model/custom_detect.py). 

## 3. Model Configuration File: [model.yaml](./person_counting_demo/model/model.yaml) 

```bash
custom_person_demo:        # Model name: the name of the model folder in model, required
