...
This article takes the `person_segmentation` algorithm as an example (real-time segmentation of human regions, drawing target contours, and triggering immediate alarms) to introduce how to package and import the algorithm into the device.
